...
arguably send to sol at the current blend in
[`prices.md`](../skills/receipts/references/prices.md) - it was held at terra
deliberately, and this benchmark does not model what sol would have cost, because that
run never happened.
